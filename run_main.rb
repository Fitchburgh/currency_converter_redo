...
def main
  ...
  puts "#{what_to_convert}what to convert, and #{final_desired_code} desired code"
  final_amount = converter_object.conversion(what_to_convert, desired_code)

  puts "#{final_amount.class}"
